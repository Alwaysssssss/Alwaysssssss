...
+ **量化**：拥有完整PTQ量化工具链开发经验，熟练掌握算法量化调优技术，能够在保证精度的前提下显著提升推理性能
+ **推理框架架构师**：具备生产级推理框架完整开发经验，独立设计实现中间表示、模型解释、计算图、运行时、图优化、内存复用等核心模块
+ **AI部署框架架构师**：nndeploy开源AI部署框架作者，基于可视化工作流和多端推理的部署框架设计理念，解决了算法工程师、部署工程师、产品开发者的不同痛点，GitHub Star 1.6k+，倍多家公司采用或参考
+ **AI落地**：在生产环境中成功部署数十个AI算法，涵盖计算机视觉、LLM等多个领域，具备丰富的工程化落地经验

## 工作经历
+ 推理框架开发与配套课程 - 华为昇腾赞助 | 独立开发者 | 2025.02 ~ 2025.08
...
+ 成果：github star 1.6k，项目被金山、小鹏、京东等大公司以及多家中小型公司参考或使用
+ 职责：开源项目发起人
  + 有向无环图模块 设计与实现
  + 图并行模块 设计与实现
  + 节点库 设计与实现
